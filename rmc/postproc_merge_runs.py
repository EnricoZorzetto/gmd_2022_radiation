...
run_merged = "output_cluster_PP3D_EastAlps_merged" # name of the desired output (merged) simulation
# list here all the runs to be merged
runs_to_merge = [
                    # "output_Laptop_test",
                    # "output_Laptop_test_run2"
                    "output_cluster_PP3D_EastAlps_run1",
                    "output_cluster_PP3D_EastAlps_run2"
                  ]
