...
python /lustre/f2/dev/Enrico.Zorzetto/Projects/GFDL_preprocessing/driver.py "experiments/cont_SEASIA2.json"
# python /lustre/f2/dev/Enrico.Zorzetto/Projects/GFDL_preprocessinbatch /driver.py "experiments/cont_SEASIA2.json"
